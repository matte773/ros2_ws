...
#include "ros2_msgs/srv/detail/save__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_msgs::srv::Save_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::srv::Save_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_msgs::srv::Save_Request *>(
    untyped_ros_message);
...
{
  return &ros2_msgs::srv::typesupport_fastrtps_cpp::_Save_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::srv::Save_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::srv::Save_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::srv::Save_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::srv::typesupport_fastrtps_cpp::_Save_Response__handle;
}
...
{
  return &ros2_msgs::srv::typesupport_fastrtps_cpp::_Save__handle;
}
