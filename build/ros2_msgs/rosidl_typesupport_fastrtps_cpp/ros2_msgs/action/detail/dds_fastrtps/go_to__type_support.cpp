...
#include "ros2_msgs/action/detail/go_to__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_msgs::action::GoTo_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_Goal & ros_message)
{
  // Member: place
  cdr >> ros_message.place;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_msgs::action::GoTo_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_Goal *>(
    untyped_ros_message);
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_Goal)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_Result)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_Feedback & ros_message)
{
  // Member: percent_complete
  cdr >> ros_message.percent_complete;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_Feedback)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_Feedback__handle;
}
...
// functions for ros2_msgs::action::GoTo_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_GoTo_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_SendGoal_Request)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_SendGoal_Response)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_SendGoal_Response__handle;
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_SendGoal)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_GetResult_Request)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for ros2_msgs::action::GoTo_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_GoTo_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_GetResult_Response)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_GetResult_Response__handle;
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_GetResult)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_GetResult__handle;
}
...
// functions for ros2_msgs::action::GoTo_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_msgs
cdr_serialize(
  const ros2_msgs::action::GoTo_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_msgs::action::GoTo_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_GoTo_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs::action::GoTo_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_msgs::action::GoTo_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_msgs::action::GoTo_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, action, GoTo_FeedbackMessage)() {
  return &ros2_msgs::action::typesupport_fastrtps_cpp::_GoTo_FeedbackMessage__handle;
}
