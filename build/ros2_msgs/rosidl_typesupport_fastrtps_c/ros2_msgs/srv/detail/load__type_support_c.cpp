...
#include "ros2_msgs/srv/detail/load__rosidl_typesupport_fastrtps_c.h"
...
using _Load_Request__ros_msg_type = ros2_msgs__srv__Load_Request;
...
size_t get_serialized_size_ros2_msgs__srv__Load_Request(
  const void * untyped_ros_message,
...
static uint32_t _Load_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_msgs__srv__Load_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_msgs
size_t max_serialized_size_ros2_msgs__srv__Load_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_msgs__srv__Load_Request;
    is_plain =
      (
...
static size_t _Load_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_msgs__srv__Load_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_msgs, srv, Load_Request)() {
...
using _Load_Response__ros_msg_type = ros2_msgs__srv__Load_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_msgs
size_t get_serialized_size_ros2_msgs__srv__Load_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Load_Response__ros_msg_type * ros_message = static_cast<const _Load_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_msgs__srv__Load_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_msgs
size_t max_serialized_size_ros2_msgs__srv__Load_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs__srv__Load_Response;
    is_plain =
      (
...
static size_t _Load_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_msgs__srv__Load_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_msgs, srv, Load_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_msgs, srv, Load)() {
  return &Load__handle;
}
