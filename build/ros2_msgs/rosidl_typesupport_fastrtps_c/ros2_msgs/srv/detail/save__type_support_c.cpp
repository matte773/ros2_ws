...
#include "ros2_msgs/srv/detail/save__rosidl_typesupport_fastrtps_c.h"
...
using _Save_Request__ros_msg_type = ros2_msgs__srv__Save_Request;
...
size_t get_serialized_size_ros2_msgs__srv__Save_Request(
  const void * untyped_ros_message,
...
static uint32_t _Save_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_msgs__srv__Save_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_msgs
size_t max_serialized_size_ros2_msgs__srv__Save_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_msgs__srv__Save_Request;
    is_plain =
      (
...
static size_t _Save_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_msgs__srv__Save_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_msgs, srv, Save_Request)() {
...
using _Save_Response__ros_msg_type = ros2_msgs__srv__Save_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_msgs
size_t get_serialized_size_ros2_msgs__srv__Save_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Save_Response__ros_msg_type * ros_message = static_cast<const _Save_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_msgs__srv__Save_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_msgs
size_t max_serialized_size_ros2_msgs__srv__Save_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_msgs__srv__Save_Response;
    is_plain =
      (
...
static size_t _Save_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_msgs__srv__Save_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_msgs, srv, Save_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_msgs, srv, Save)() {
  return &Save__handle;
}
