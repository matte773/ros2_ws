...
class Metaclass_Patrol_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_msgs.action.Patrol_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Patrol_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_msgs.action.Patrol_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Patrol_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros2_msgs.action import Patrol
...
class Patrol_SendGoal_Request(metaclass=Metaclass_Patrol_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ros2_msgs/Patrol_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_msgs', 'action'], 'Patrol_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_msgs.action._patrol import Patrol_Goal
...
class Metaclass_Patrol_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_msgs.action.Patrol_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_msgs.action import _patrol
...
class Patrol_SendGoal(metaclass=Metaclass_Patrol_SendGoal):
    from ros2_msgs.action._patrol import Patrol_SendGoal_Request as Request
    from ros2_msgs.action._patrol import Patrol_SendGoal_Response as Response
...
class Patrol_GetResult_Response(metaclass=Metaclass_Patrol_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ros2_msgs/Patrol_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_msgs', 'action'], 'Patrol_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_msgs.action._patrol import Patrol_Result
...
class Metaclass_Patrol_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_msgs.action.Patrol_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Patrol_GetResult(metaclass=Metaclass_Patrol_GetResult):
    from ros2_msgs.action._patrol import Patrol_GetResult_Request as Request
    from ros2_msgs.action._patrol import Patrol_GetResult_Response as Response
...
class Metaclass_Patrol_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_msgs.action.Patrol_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Patrol_FeedbackMessage(metaclass=Metaclass_Patrol_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ros2_msgs/Patrol_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_msgs', 'action'], 'Patrol_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ros2_msgs.action._patrol import Patrol_Feedback
...
class Patrol(metaclass=Metaclass_Patrol):
    ...
    from ros2_msgs.action._patrol import Patrol_Goal as Goal
    # The result message defined in the action definition.
    from ros2_msgs.action._patrol import Patrol_Result as Result
    # The feedback message defined in the action definition.
    from ros2_msgs.action._patrol import Patrol_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ros2_msgs.action._patrol import Patrol_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ros2_msgs.action._patrol import Patrol_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ros2_msgs.action._patrol import Patrol_FeedbackMessage as FeedbackMessage
