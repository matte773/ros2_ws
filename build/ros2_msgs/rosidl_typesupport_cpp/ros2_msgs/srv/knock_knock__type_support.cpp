...
static const _KnockKnock_Request_type_support_symbol_names_t _KnockKnock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, srv, KnockKnock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_msgs, srv, KnockKnock_Request)),
  }
};
...
{
  return &::ros2_msgs::srv::rosidl_typesupport_cpp::KnockKnock_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_msgs, srv, KnockKnock_Request)() {
  return get_message_type_support_handle<ros2_msgs::srv::KnockKnock_Request>();
}
...
static const _KnockKnock_Response_type_support_symbol_names_t _KnockKnock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, srv, KnockKnock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_msgs, srv, KnockKnock_Response)),
  }
};
...
{
  return &::ros2_msgs::srv::rosidl_typesupport_cpp::KnockKnock_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_msgs, srv, KnockKnock_Response)() {
  return get_message_type_support_handle<ros2_msgs::srv::KnockKnock_Response>();
}
...
static const _KnockKnock_type_support_symbol_names_t _KnockKnock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_msgs, srv, KnockKnock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_msgs, srv, KnockKnock)),
  }
};
...
{
  return &::ros2_msgs::srv::rosidl_typesupport_cpp::KnockKnock_service_type_support_handle;
}
